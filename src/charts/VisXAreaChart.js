...
const cityTemperature = visXData(); 
...
export const VisXAreaChart = ({ width, height, margin = defaultMargin }) => {
    ...
    return (
        <div style={styles.container}>
            <h3 style={styles.title}>VisX Area Chart</h3>
